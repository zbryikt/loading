...
define(['default', 'infinity', 'ellipsis', 'dashinfinity', 'reload', 'wheel', 'g0v', 'pacman', 'facebook', 'spin', 'ball', 'cube', 'circle', 'pie', 'radio', 'poi', 'gear', 'gears', 'comment', 'wave', 'battery', 'sunny', 'triangle', 'flickr', 'ring'], function(){
  var x$;
  x$ = angular.module('uiloading');
